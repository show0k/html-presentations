...
* scientists
* artists
Poppy is a an open source robotic project. The project began with this robot, poppy humanoid.
open source
...
<table> 
    ...
    <td>
    <img src="pictures/science_legs.png" style="border-style: none" width="150%"/>
   </td>
</tr>
</table>
...
Note:
It's made to be easy to mount. You just need a screwdriver a a long day. It's like Meccano for adults.
